...
import com.codepay.openapi.response.WisehubCloudPayCloseResponse;
...
@Setter
@ToString
public class WisehubCloudPayCloseRequest extends OpenApiRequest<WisehubCloudPayCloseResponse> {
